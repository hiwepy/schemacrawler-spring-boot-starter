...
public abstract class AbstractSchemaCrawlerSystemTest {
	...
	protected final String[] dataSources = { "MicrosoftSQLServer", "Oracle", "IBM_DB2", "MySQL", "PostgreSQL",
			// "Derby",
	};
	...
	protected Connection connect(final String dataSourceName) throws Exception {
		final ConnectionOptions connectionOptions = (ConnectionOptions) appContext.getBean(dataSourceName);
